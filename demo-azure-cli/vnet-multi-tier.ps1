...
$subnetFrontEnd="demo-frontend-subnet"
$subnetPrefixFrontEnd="10.0.1.0/24"
$nsgFrontEnd="demo-nsg-frontend"
$subnetBackEnd="demo-backend-subnet"
$subnetPrefixBackEnd="10.0.2.0/24"
$nsgBackEnd="demo-nsg-backend"
$publicIpWeb="demo-public-ip-web"
$publicIpSql="demo-public-ip-sql"
$nicWeb="demo-nic-web"
$nicSql="demo-nic-sql"
$image="UbuntuLTS"
$login="azureuser"
